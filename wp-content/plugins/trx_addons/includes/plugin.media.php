...
//											: '')
			...
			if ($args['style']=='modern' || $args['titles']=='outside') {
				if ($args['engine'] == 'swiper' && trx_addons_is_on($args['pagination']) 
			...
			if ($args['engine'] == 'swiper' && trx_addons_is_on($args['pagination']) && !$out_pagination) {
			...
			if (!$close_inner) $output .= '</div><!-- /.slider_container -->';
