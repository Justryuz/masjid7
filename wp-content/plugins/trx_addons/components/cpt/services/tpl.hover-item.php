...
?>>
	<div class="sc_services_item_header <?php echo (int)$args['hide_bg_image']==1 ? ' without_image' : ''; ?>"<?php if ((int)$args['hide_bg_image']==0 && !empty($image)) echo ' style="background-image: url('.esc_url($image).');"'; ?>>
