	...
	function trx_addons_woocommerce_login_menu_settings() {
		if (trx_addons_exists_woocommerce()) {
			...
			if ( !empty( $myaccount_page_id ) ) {
				?><a href="<?php echo esc_url(get_permalink( $myaccount_page_id )); ?>" class="trx_addons_login_menu_item trx_addons_icon-edit"><?php esc_html_e('My account', 'trx_addons'); ?></a><?php
			}
		}
	}
}
