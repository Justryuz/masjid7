...
class trx_addons_demo_data_importer {
	...
	function admin_scripts() {
      ...
      wp_enqueue_style( 'trx_addons-icons', trx_addons_get_file_url('css/font-icons/css/trx_addons_icons-embedded.css'), array(), null );
		if ( is_rtl() ){
			wp_enqueue_style(  'trx_addons-importer-rtl',  trx_addons_get_file_url(TRX_ADDONS_PLUGIN_IMPORTER . 'rtl-importer.css'), array(), null );
		}		
	}
	...
	function exporter() {
		...
		trx_addons_fpc(trx_addons_get_file_dir(TRX_ADDONS_PLUGIN_IMPORTER . 'export/theme_mods.txt'), serialize($this->prepare_data(apply_filters('trx_addons_filter_export_mods', get_theme_mods()))));
		...
		trx_addons_fpc(trx_addons_get_file_dir(TRX_ADDONS_PLUGIN_IMPORTER . 'export/theme_options.txt'), serialize($this->prepare_data(apply_filters('trx_addons_filter_export_options', $options))));
		...
		trx_addons_fpc(trx_addons_get_file_dir(TRX_ADDONS_PLUGIN_IMPORTER . 'export/widgets.txt'), serialize($this->prepare_data(apply_filters('trx_addons_filter_export_widgets', $options))));
