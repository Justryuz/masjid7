...
if (!function_exists('shaha_hovers_theme_setup3')) {
	add_action( 'after_setup_theme', 'shaha_hovers_theme_setup3', 3 );
	function shaha_hovers_theme_setup3() {

		// Add 'Buttons hover' option
		shaha_storage_set_array_after('options', 'border_radius', array(
			'button_hover' => array(
				"title" => esc_html__("Button's hover", 'shaha'),
				"desc" => wp_kses_data( __('Select hover effect to decorate all theme buttons', 'shaha') ),
				"std" => 'slide_left',
				"options" => array(
					'default'		=> esc_html__('Fade',				'shaha'),
					'slide_left'	=> esc_html__('Slide from Left',	'shaha'),
					'slide_right'	=> esc_html__('Slide from Right',	'shaha'),
					'slide_top'		=> esc_html__('Slide from Top',		'shaha'),
					'slide_bottom'	=> esc_html__('Slide from Bottom',	'shaha')
				),
				"type" => "select"
			),
			'image_hover' => array(
				"title" => esc_html__("Image's hover", 'shaha'),
				"desc" => wp_kses_data( __('Select hover effect to decorate all theme images', 'shaha') ),
				"std" => 'dots',
				"override" => array(
					'mode' => 'page',
				...
				"options" => array(
					'dots'	=> esc_html__('Dots',	'shaha'),
					'icon'	=> esc_html__('Icon',	'shaha')
				),
				"type" => "select"
			) )
		);
...
if (!function_exists('shaha_hovers_theme_setup9')) {
	add_action( 'after_setup_theme', 'shaha_hovers_theme_setup9', 9 );
	function shaha_hovers_theme_setup9() {
		add_action( 'wp_enqueue_scripts',		'shaha_hovers_frontend_scripts', 1010 );
		add_filter( 'shaha_filter_localize_script','shaha_hovers_localize_script' );
		add_filter( 'shaha_filter_merge_scripts',	'shaha_hovers_merge_scripts' );
		add_filter( 'shaha_filter_merge_styles',	'shaha_hovers_merge_styles' );
		add_filter( 'shaha_filter_get_css', 		'shaha_hovers_get_css', 10, 4 );
	}
}
	
// Enqueue hover styles and scripts
if ( !function_exists( 'shaha_hovers_frontend_scripts' ) ) {
	
	function shaha_hovers_frontend_scripts() {
		if ( shaha_is_on(shaha_get_theme_option('debug_mode')) && shaha_get_file_dir('theme-specific/theme.hovers/theme.hovers.js')!='' )
			wp_enqueue_script( 'shaha-hovers', shaha_get_file_url('theme-specific/theme.hovers/theme.hovers.js'), array('jquery'), null, true );
		if ( shaha_is_on(shaha_get_theme_option('debug_mode')) && shaha_get_file_dir('theme-specific/theme.hovers/theme.hovers.css')!='' )
			wp_enqueue_style( 'shaha-hovers',  shaha_get_file_url('theme-specific/theme.hovers/theme.hovers.css'), array(), null );
	}
}

// Merge hover effects into single js
if (!function_exists('shaha_hovers_merge_scripts')) {
	
	function shaha_hovers_merge_scripts($list) {
...
if (!function_exists('shaha_hovers_merge_styles')) {
	
	function shaha_hovers_merge_styles($list) {
...
if (!function_exists('shaha_hovers_localize_script')) {
	
	function shaha_hovers_localize_script($arr) {
		$arr['button_hover'] = shaha_get_theme_option('button_hover');
		return $arr;
	}
}

// Add hover icons on the featured image
if ( !function_exists('shaha_hovers_add_icons') ) {
	function shaha_hovers_add_icons($hover, $args=array()) {
...
// Add styles into CSS
if ( !function_exists( 'shaha_hovers_get_css' ) ) {
	
	function shaha_hovers_get_css($css, $colors, $fonts, $scheme='') {
...
.sc_button_hover_style_link2.sc_button_hover_slide_left {	    background: linear-gradient(to right,	{$colors['text_link']} 50%, {$colors['text_link2']} 50%) no-repeat scroll right bottom / 210% 100% {$colors['text_link2']} !important; }
.sc_button_hover_style_link2.sc_button_hover_slide_right {      background: linear-gradient(to left,	{$colors['text_link']} 50%, {$colors['text_link2']} 50%) no-repeat scroll left bottom / 210% 100% {$colors['text_link2']} !important; }
.sc_button_hover_style_link2.sc_button_hover_slide_top {	    background: linear-gradient(to bottom,	{$colors['text_link']} 50%, {$colors['text_link2']} 50%) no-repeat scroll right bottom / 100% 210% {$colors['text_link2']} !important; }
.sc_button_hover_style_link2.sc_button_hover_slide_bottom {	    background: linear-gradient(to top,		{$colors['text_link']} 50%, {$colors['text_link2']} 50%) no-repeat scroll right top / 100% 210% {$colors['text_link2']} !important; }
...
.sc_button_hover_style_dark.sc_button_hover_slide_left {		background: linear-gradient(to right,	{$colors['text_link2']} 50%, {$colors['inverse_link']} 50%) no-repeat scroll right bottom / 210% 100% {$colors['inverse_link']} !important; }
...
.sc_button_hover_style_inverse.sc_button_hover_slide_left:hover,
.sc_button_hover_style_inverse.sc_button_hover_slide_right:hover,
.sc_button_hover_style_inverse.sc_button_hover_slide_top:hover,
.sc_button_hover_style_inverse.sc_button_hover_slide_bottom:hover  {	color: {$colors['text_dark']} !important; }
...
li.active .sc_button_hover_slide_left {		background-position: left bottom !important; color: {$colors['inverse_text']} !important; }

.sc_button_hover_slide_right:hover,
.sc_button_hover_slide_right.active,
.ui-state-active .sc_button_hover_slide_right,
.vc_active .sc_button_hover_slide_right,
li.active .sc_button_hover_slide_right {	background-position: right bottom !important; color: {$colors['inverse_text']} !important; }

.sc_button_hover_slide_top:hover,
.sc_button_hover_slide_top.active,
.ui-state-active .sc_button_hover_slide_top,
.vc_active .sc_button_hover_slide_top,
li.active .sc_button_hover_slide_top {		background-position: right top !important; color: {$colors['inverse_text']} !important; }

.sc_button_hover_slide_bottom:hover,
.sc_button_hover_slide_bottom.active,
.ui-state-active .sc_button_hover_slide_bottom,
.vc_active .sc_button_hover_slide_bottom,
li.active .sc_button_hover_slide_bottom {	background-position: right bottom !important; color: {$colors['inverse_text']} !important; }
