...
You can install it from the menu 'Appearance->Install plugins' or on the page 'Appearance->About ICA'.
Please install and activate it before starting to use the theme ICA.
Also the theme supports many popular plugins such as 'Revolution Slider', 'WPBakery Page Builder' and many more.


III. Documentation

Theme documentation is available on http://ica.ancorathemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in ICA is Fontello.
