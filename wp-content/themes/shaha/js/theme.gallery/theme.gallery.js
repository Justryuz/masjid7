...
;(function(window) {
	...
	GalleryFx.prototype.options = {
		...
		imgPosition : { x : 1, y : 1 },		// Preview window size
											...
											// So, as an example, if we want our large image to be positioned vertshahally on 25% of the screen and centered horizontally the values would be x:1,y:-0.25
	...
	jQuery(document).on('action.init_hidden_elements', function(e, cont) {
		...
		cont.find('.gallery_wrap:not(.inited)').each(function(idx) {
			...
			if (!SHAHA_STORAGE['GalleryFx']) SHAHA_STORAGE['GalleryFx'] = {};
			...
			SHAHA_STORAGE['GalleryFx'][id] = new GalleryFx(this, {
