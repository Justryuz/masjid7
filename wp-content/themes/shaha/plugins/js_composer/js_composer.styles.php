...
if ( !function_exists( 'shaha_vc_get_css' ) ) {
	add_filter( 'shaha_filter_get_css', 'shaha_vc_get_css', 10, 4 );
	function shaha_vc_get_css($css, $colors, $fonts, $scheme='') {
...
.vc_tta-color-grey.vc_tta-style-classic .vc_tta-tab > a {		background: linear-gradient(to right,	{$colors['text_link']} 50%, {$colors['text_hover']} 50%) no-repeat scroll right bottom / 210% 100% {$colors['text_hover']} !important; }
